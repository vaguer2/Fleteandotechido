...
export default function ScreenLoginFletero() {
    ...
    const iniciarSesion = async () => {
        ...
        try {
            ...
            // El AuthProvider detecta automáticamente que es fletero
            // y redirige a ScreenHomeFletero
    ...
    return (
        ...
        >
            ...
            <View style={styles.cuadroInputs}>
                ...
                <Text style={styles.subtitulo}>Ingresa tus datos para iniciar sesión</Text>
                ...
                <View style={styles.filaRegistro}>
                    ...
                    <Pressable onPress={() => router.push('./Screen/Register/ScreenFleteroRegister')}> {/*aqui cambie*/}
...
const styles = StyleSheet.create({
    ...
    titulo: { fontFamily: 'Poppins_700Bold', fontSize: 22, color: '#0D2240', marginBottom: 4 },
    ...
    filaRegistro: { flexDirection: 'row', justifyContent: 'center' },
    textoGris: { fontFamily: 'Inter_400Regular', fontSize: 13, color: '#888' },
    textoInicio: { fontFamily: 'Poppins_800ExtraBold', fontSize: 26, color: '#fff', marginLeft: 7 },
    textoAlLado: { fontFamily: 'Poppins_800ExtraBold', fontSize: 26, color: '#F97316', marginLeft: 4 },
