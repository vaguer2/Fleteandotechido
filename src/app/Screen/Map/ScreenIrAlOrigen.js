...
export default function ScreenIrAlOrigen() {
    ...
    const [procesandoLlegada, setProcesandoLlegada] =
        useState(false);
    const [procesandoInicio, setProcesandoInicio] =
        useState(false);

    /*
     * El mapa se adapta a la altura del dispositivo,
     * pero conserva límites para no quedar demasiado
     * pequeño ni ocupar toda la pantalla.
     */
    const alturaMapa = Math.min(
        Math.max(height * 0.3, 190),
        260
    );
                ...
                },
                {
                    ...
                    onPress: async () => {
                        ...
                        try {
                            ...
                            router.replace(
                                '/Screen/Home/ScreenHomeFletero'
                            );
                        } catch (error) {
                            console.log(
                                'Error general al iniciar servicio:',
                                error
                            );
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Botones inferiores fijos y protegidos */}
            <SafeAreaView
