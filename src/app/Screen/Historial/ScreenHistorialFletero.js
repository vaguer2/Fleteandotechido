...
export default function ScreenHistorialFletero() {
    ...
    useEffect(() => {
        async function cargarHistorial() {
            ...
            const { data, error } = await supabase
                .from('solicitud')
                .select('*, categoria_carga(nombre), punto_ruta(*), usuario(nombre)')
        ...
        <View style={styles.container}>
            ...
            {cargando ? (
                ...
                <View style={styles.centrado}>
                    ...
                    <Text style={styles.sinServiciosTexto}>
                        Aun no has completado ningun servicio
                    </Text>
                </View>
            ) : (
                            ...
                            <View key={item.solicitud_id} style={styles.card}>
                                ...
                                <View style={styles.infoRow}>
                                    <View style={styles.infoItem}>
                                        ...
                                        <Text style={[styles.infoValor, styles.ganancia]}>
                                    ...
                                    <View style={styles.infoItem}>
                                        ...
                                        <Text style={styles.infoValor}>
                                            {calcularDuracion(item.hora_inicio, item.hora_fin)}
                                        </Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.infoRow}>
                                    <View style={styles.infoItem}>
                                        ...
                                        <Text style={styles.infoValor}>
                                            {item.usuario?.nombre ?? 'No disponible'}
                                        </Text>
                                    </View>
                                    <View style={styles.infoItem}>
...
const styles = StyleSheet.create({
    ...
    folio: { fontSize: 13, fontWeight: '700', color: '#0b2545' },
    ...
    ganancia: { color: '#F97316', fontSize: 15 },
});