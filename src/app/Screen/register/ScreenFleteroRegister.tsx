    ...
    return (
        <View style={styles.fondo}>
            ...
            <View style={styles.cuadroInputs}>
                ...
                {/* campo del nombre */}
                <Text style={styles.etiqueta}>Nombre de tu empresa</Text>
                <TextInput
                    style={styles.input}
                    placeholder="Ej. Fletes del caribe del S.A de C.V"
                    placeholderTextColor="#aaa"
                    value={company}
                    onChangeText={(compania) => {
                        setCompany(compania);
                ...
                {/* Campo correo */}
                <Text style={styles.etiqueta}>Correo electronico empresaria</Text>
                <TextInput
                    style={styles.input}
                    placeholder="Ej. fletesYmudanzas@gmail.com"
                    placeholderTextColor="#aaa"
                    value={mail}
                    onChangeText={(texto) => {
                        setMail(texto);
